$(function() { 
	   ...
	   $(".input").blur(function() {//lose focus.
		var inputName = $(this).attr("name");
		invokeValidateFunction(inputName);
	    });
	    
	     $(".input").focus(function() {//get focus
		 var inputName = $(this).attr("name");
         var str=inputName.replace(/loginUser./,"");//? 用空字符串代替loginUser.
    ...
    function validateimageValue() {
       ...
       function check(){
    		...
    		$(".input").each(function() {
    			var inputName = $(this).attr("name");
    			if(!invokeValidateFunction(inputName)) {//是否通过验证。
    				bool = false;
    			}
    		})
    		return bool;
